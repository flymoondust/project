...
class GlobalScreenshot {
    ...
    void takeScreenshot(Runnable finisher, boolean statusBarVisible, boolean navBarVisible) {
        ...
        //raymanfeng: Allow for abnormal hardware orientation
        int prop_rot = android.os.SystemProperties.getInt("ro.sf.hwrotation", 0);
        if(prop_rot == 0)
            prop_rot = android.os.SystemProperties.getInt("au.hw.rotation", 0);
        rot = (rot + (prop_rot / 90 )) % 4;
